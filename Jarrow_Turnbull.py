...
#Choose one company of a given period (day) to construct the lambda curve
...
rawdata.head()
data1 = rawdata[['BUSINESS_DATE', 'OBLIGATION_ASSETRANK', 'CREDIT_EVENTS','INSTITUTION_NAME',
                 'BID', 'OFFER', 'TRADE']]
firm = ['British', 'Airways']
data1 = data1[data1['INSTITUTION_NAME'].str.contains('British Airways', na = False)]
