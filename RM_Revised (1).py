...
#stock_prices = CallPrice(AdjCloseFloat, 25, 0.8, 1, 0.005, 0.0)
#for i in AdjCloseFloat.iteritems(): 
    #stock_prices = CallPrice(i, 25, 0.8, 1, 0.005, 0.0)
    #print(stock_prices)
    
#for i in AdjCloseFloat.iteritems() :
    #call = CallPrice(AdjCloseFloat[i],22,1,sigma,0.005,0)
    #print(stock_prices)
sigma = np.std(finaldata['Daily Return'])
